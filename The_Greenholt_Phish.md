...
> **Category:** Phishing Analysis / Email Forensics / SOC
> **Difficulty:** Easy
...
**Analysis / Red Flags:** Email is not professionally formatted / suspicious attachment file type / suspicious emails, not SWIFT domain emails
 
---
 
### Phase 2 — Message Source & Origin
 
> The `Received:` headers log each mail server hop. Reading them bottom-to-top traces the message back to its origin — the bottom-most `Received` line is the first hop, i.e. where it actually came from.
 
**Originating IP address:** `192.119.71.157`
**How you found it:** In the email source file.
...
*Writeup by Chris Janciga · 9/18/26 · Formatted using Claude Opus 4.8*
